...
const About = () => {
  ...
  return (
    <div className="about-container">
      <div className={`about a1 ${inView1 ? 'animate__animated animate__fadeInLeft animate__slow	' : ''}`} ref={ref1} >
      ...
      <div className={`about a2 ${inView2 ? 'animate__animated animate__fadeInRight animate__slow' : ''}`} ref={ref2}>
      ...
      <div className={`about a3 ${inView3 ? 'animate__animated animate__fadeInLeft animate__slow' : ''}`} ref={ref3}>
